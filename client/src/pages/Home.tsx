...
const CARD_CONFIGS = [
  ...
  // RIGHT SIDE
  { service: 'CRM',               top: '13%',  right: '12%', mTop: '7%',              mRight: '1%', size: 'lg' as const, delay: 0.05 },
  ...
  { service: 'Content Marketing', top: '21%', right: '25%', mTop: '64%',             mRight: '1%', size: 'md' as const, delay: 0.45 },
];
